...
enum TaskUriEnum {
    ...
    TASK_NOTE_ID(105,null,TaskContract.PATH_TASK+"/*"+TaskContract.PATH_TASK_NOTE,Tasks.CONTENT_ITEM_TYPE),
    ...
    GOAL_PLAN_ID(302,null,TaskContract.PATH_GOAL+"/*"+TaskContract.PATH_PLAN,Goals.CONTENT_ITEM_TYPE),
